...
class employeeClass:
    def __init__(self,root):
        ...
        txt_empid=Entry(self.root,textvariable=self.var_name,font=("goudy old style",15),bg="lightyellow").place(x=150,y=190,width=180)
    ...
    def add(self):
        ...
        try:
            if self.var_emp_id.get()=="":
                messagebox.showerror("Error","Emloyee ID is required",parent=self.root)
            else:
